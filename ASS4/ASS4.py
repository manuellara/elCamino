...
#   append ID to idList
#   append salary to salList
#   append tax to taxList
#   append net to netList
...
#
# sorting :
# takes 5 parameters : nameList , idList , salList , taxList , netList 
# zips lists together and stores result in data
# then sort data by the '0' element ( names )
# start a for loop from 0 to length of data
# split up each of data's index to name , id , salary , tax , net
# if ID length does not equal 4
...
# takes avgNet , highestNet , highestName , lowestNet , lowestName as parameters 
# avg net income statement is printed 
# highestNet income statement is printed 
# lowestNet income statement is printed 
#
# output :
# takes count , name , ID , salary , tax , net as parameters 
...
import sys
# MAIN #
fileName = input( "Drag a file in: " )                                     #gets file path
outputName = input("Enter output file name :" )                            #gets name for output file

# FUNTION CALL #
inputFile( fileName , outputName )                                         #calls inputFile and passes 'fileName' and 'outputName'